...
namespace Unit_5
{
    internal class Program
    {
        ...
        {   // link: https://learn.microsoft.com/en-us/training/modules/csharp-literals-variables/5-implicitly-typed-local-variables

            // Declare implicitly typed local variables
            // The C# compiler works behind the scenes to assist you as you write your code.
            ...
            // Because the variable message is immediately set to the string value "Hello World!",
            // the C# compiler understands the intent and treats every instance of message as an instance of type string.
            //In fact,
            ...
            */
             ...
             *  In C#, 
             *  variables are assigned a type by the compiler regardless
             *  of whether you use the actual data type name or allow the compiler to imply the data type. 
             *  In other words, 
            ...
            // If you try to use the var keyword without initializing the variable,
            ...
            // It's likely that if you look at a code example in a book or online,
            // you'll see the var keyword used instead of the actual data type name,
            // so it's important to understand its usage.
            // The var keyword has an important use in C#. Many times,
            // the type of a variable is obvious from its initialization.
            ...
            // When you begin developing code for a task,
            // you may not immediately know what data type to use.
            // Using var can help you develop your solution more dynamically.
            //
            // As you get started,
            // it is recommended that you continue to use the actual data type name when you declare variables until you become more comfortable working with code.
