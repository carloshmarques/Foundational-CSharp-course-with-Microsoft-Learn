...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            // https://learn.microsoft.com/en-us/training/modules/challenge-project-develop-branching-looping-structures-c-sharp/3-exercise-build-loop-verify-physical
            ...
            // Loop to insert and edit pet age:
            for (int  i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i,2] == "Age: ?" && ourAnimals[i, 2] != "ID #: ")
                {
                    do
                    {
                ...
                // Loop to insert and edit pet physical description:
                ...
                // end pet physical description loop
            }
